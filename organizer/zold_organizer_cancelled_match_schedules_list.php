...
<head>
    ...
    <link rel="stylesheet" href="..//ostyles/organizer_match_schedules_list.css">
    <title>organizer | Cancelled Match Schedules</title>
...
<body>
    <div class="container">
        ...
        <a href="../organizer/organizer_dashboard.php">
            ...
            <form method="POST" action="../organizer/logout.php">
