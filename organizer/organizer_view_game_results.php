...
require_once '../db_connection.php';
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['result_id'])) {
        ...
        if ($stmt->execute()) {
            echo "<script>alert('Game result deleted successfully!'); window.location.href='organizer_view_game_results.php';</script>";
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="../ostyles/organizer_view_game_results.css">
                    ...
                    <tbody>
                        <?php while ($row = $teamResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <!-- <a href="../organizer/organizer_edit_game_result.php?id=<?= $row['id'] ?>" class="edit-btn">Edit</a>
                                    <br><br> -->
                                    <button class="delete-btn" onclick="openModal(<?= $row['id'] ?>)">Delete</button>
                                    <br><br>
                                    <a href="../organizer/organizer_view_teams.php">Go To Teams</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
