...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Post deleted successfully!'); window.location.href = 'organizer_league_list.php';</script>";
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="..//ostyles/organizer_league_list.css">
    <title>organizer | League List</title>
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
                <div class="announcement">
                    ...
                    <!-- Edit Button -->
                    <button><a href="../organizer/organizer_league_edit.php?id=<?= $row['id']; ?>">Edit Post</a></button>
