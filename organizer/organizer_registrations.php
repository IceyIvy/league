...
<head>
    ...
    <link rel="stylesheet" href="..//ostyles/organizer_registrations.css">
    <title>organizer | Registrations</title>
...
<body>
    <div class="container">
        ...
        <a href="../organizer/organizer_dashboard.php">
            ...
            <!-- <button class="nav-btn" onclick="window.location.href='../organizer/organizer_'">Add Organizer</button>
                    ...
                    <tbody>
                        <?php while ($row = $applicantsResult->fetch_assoc()): ?>
                            ...
                            <td><?php echo $row['id']; ?></td>
                                ...
                                <td>
                                    <a class="new-edit-btn" href="../organizer/organizer_edit_applicant.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit</a>
                                    <style>
                                        .new-edit-btn {
