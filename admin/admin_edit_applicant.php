<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_applicant'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>window.location.href = 'admin_edit_applicant.php?id=$applicant_id';</script>";
        } else {
            ...
            if ($updateStmt->execute()) {
                ...
                if ($deleteStmt) {
                    ...
                    if ($deleteStmt->execute()) {
                        ...
                        echo "<script>window.location.href = 'admin_registrations.php';</script>";
                    } else {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['decline_applicant'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>window.location.href = 'admin_registrations.php';</script>"; // Redirect to applicant list page
            } else {
                // Error handling
...
<head>
    ...
    <title>Admin | Edit Applicant</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../styles/admin_edit_applicant.css">
</head>
<body>
    <div class="container">
        <aside class="sidebar">
