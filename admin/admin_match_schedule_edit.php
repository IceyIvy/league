...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_match'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Match schedule updated successfully!'); window.location.href='admin_match_schedules.php?id=$matchId';</script>";
        exit;
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_match_schedule_edit.css">
    <title>Admin | Edit Match Schedule</title>
</head>
<body>
    <div class="container">
        <aside class="sidebar">
