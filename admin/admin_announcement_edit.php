...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    echo "<script>alert('Invalid request.'); window.location.href='admin_announcement_list.php';</script>";
    exit();
}
...
if ($result->num_rows === 0) {
    echo "<script>alert('Post not found!'); window.location.href='admin_announcement_list.php';</script>";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($updateStmt->execute()) {
        echo "<script>alert('Announcement updated successfully!'); window.location.href='admin_announcement_list.php';</script>";
        exit();
    } else {
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_announcement_edit.css">
    ...
    <div class="container">
        ...
        <main class="main-content">
            <form class="form-container" method="POST">
                ...
                <!-- <a href="admin_announcement_list.php" class="cancel-btn">Cancel</a> -->
            </form>
        </main>
    </div>
</body>
