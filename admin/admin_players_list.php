...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_players_list.css">
    <title>Admin | Players List</title>
</head>
<body>
    <div class="container">
        <aside class="sidebar">
                    ...
                    <tbody>
                        <?php while ($row = $applicantsResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <!-- <td>
                                    <a href="../admin/admin_player_edit.php?id=<?php //echo $row['id']; ?>" class="edit-btn">Edit</a>
                                </td> -->

                                <td>
                                    <a class="new-edit-btn" href="../admin/admin_player_edit.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit</a>
                                    <style>
