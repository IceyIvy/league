...
<head>
    ...
    <link rel="stylesheet" href="..//styles/admin_match_schedules.css">
    <title>Admin | Match Schedules</title>
                    ...
                    <tbody>
                        <?php while ($row = $matchSchedulesResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="new-edit-btn" href="../admin/admin_match_schedule_edit.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit</a>
                                    <style>
