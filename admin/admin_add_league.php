...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($who) && !empty($what) && !empty($when) && !empty($where) && !empty($why)) {
        ...
        if ($stmt) {
            ...
            // Execute the query
            if ($stmt->execute()) {
                echo "<script>alert('Announcement posted successfully'); window.location.href='../admin/admin_dashboard.php';</script>";
            } else {
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_add_league.css">
    <title>Admin | Add League</title>
</head>
