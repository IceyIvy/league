...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_edit_organizer.css">
</head>
    ...
    <div class="container">
        ...
        <a href="../admin/admin_dashboard.php">
            ...
            <div class="nav-buttons">
                ...
                <button class="nav-btn" onclick="window.location.href='../admin/admin_organize_games.php'">Manage Games</button>
