    ...
    if (isset($_POST['decline_id']) && isset($_POST['reason'])) {
        ...
        if ($bookingResult->num_rows > 0) {
            ...
            if ($insertStmt->execute()) {
                ...
                header("Location: admin_bookings_approved.php?message=Booking cancelled successfully");
                exit();
            } else {
...
<body>
    <div class="container">
        ...
        <form class="form-container" method="POST" action="">
            ...
            <?php endif; ?>
            <h5 class="cancel-note">NOTE: This CANCELS all of the BOOKINGS of a specific date. If you wish to continue, use DATE.</h5>
            <style>
                .cancel-note{
                    color: gray;
                }
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Payment</th>
                            <th>Date Approved <br><i>(YY-MM-DD HH:MM:SS)</i></th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = $approvedBookingsResult->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <button class="new-decline-btn" onclick="openModal(<?php echo $row['id']; ?>)" class="edit-btn">Cancel Booking Schedule</button>
                                    <style>
