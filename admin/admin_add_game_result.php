    ...
    if (!empty($team_a_id) && !empty($team_b_id) && !empty($description)) {
        if ($team_a_id !== $team_b_id) {  // Ensure Team A and Team B are different
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>alert('Match result successfully recorded!'); window.location.href='admin_dashboard.php';</script>";
            } else {
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_add_game_result.css">
    <title>Admin | Add Game Result</title>
</head>
