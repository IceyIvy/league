...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_accounts.css">
    ...
    <div class="container">
        ...
        <a href="../admin/admin_dashboard.php">
            ...
            <div class="nav-buttons">
                ...
                <!-- <button class="nav-btn" onclick="window.location.href='../admin/admin_manage.php'">Manage</button> -->
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Email</th>
                    <th>Role</th>
                    <th>Created At <br><i>YYYY-MM-DD HH:MM:SS</i></th>
                    <th>Last Session <br><i>YYYY-MM-DD HH:MM:SS</i></th>
                    <th>Action</th>
                </tr>
            </thead>
            <tbody>
                <?php while ($row = $activeResult->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <!-- <a href="admin_edit_organizer.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit Organizer</a> -->
                            <a href="admin_edit_organizer.php?id=<?php echo $row['id']; ?>" class="edit-btn">Edit Organizer</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
