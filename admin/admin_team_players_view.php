...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'Admin') {
    ...
    if (!isset($_GET['id']) || empty($_GET['id'])) {
        die("<script>alert('Invalid team ID.'); window.location.href = 'admin_view_teams.php';</script>");
    }
    ...
    if ($teamResult->num_rows === 0) {
        die("<script>alert('Team not found.'); window.location.href = 'admin_view_teams.php';</script>");
    }
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_team_players_view.css">
    <title>Admin | Players <?php echo htmlspecialchars($team_name); ?></title>
</head>
<body>
    <div class="container">
        <!-- Sidebar -->
        ...
        <a href="../admin/admin_dashboard.php">
            ...
            <button class="nav-btn" onclick="window.location.href='../admin/admin_add_organizer.php'">Add Organizer</button>
                ...
                <button class="nav-btn selected" onclick="window.location.href='../admin/admin_organize_league.php'">Organize League</button>
