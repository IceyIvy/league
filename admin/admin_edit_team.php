    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_team'])) {
        ...
        if ($stmt->execute()) {
            ...
            if ($stmt->execute()) {
                ...
                echo "<script>window.location.href = 'admin_edit_team.php?id=$team_id';</script>";
            } else {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>window.location.href = 'admin_view_teams.php';</script>"; // Redirect to team list page
                } else {
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_edit_team.css">
</head>
<body>
    <div class="container">
        <aside class="sidebar">
        <a href="../admin/admin_dashboard.php">
            ...
            <button class="nav-btn" onclick="window.location.href='../admin/admin_add_organizer.php'">Add Organizer</button>
                ...
                <button class="nav-btn" onclick="window.location.href='../admin/admin_bookings_decline.php'">Decline Bookings</button>
