<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_player'])) {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>window.location.href = 'admin_player_edit.php?id=$player_id';</script>";
        } else {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_player'])) {
        ...
        echo "<script>window.location.href = 'admin_players_list.php';</script>"; // Redirect to player list page
    }
...
<head>
    ...
    <link rel="stylesheet" href="../styles/admin_player_edit.css">
